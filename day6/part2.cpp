...
void turn_on(std::vector<std::vector<int>> & grid, const std::vector<int> & instruction) {
...
void turn_off(std::vector<std::vector<int>> & grid, const std::vector<int> & instruction) {
    int start_x = instruction[1];
    int start_y = instruction[2];
    int end_x = instruction[3];
    int end_y = instruction[4];
...
void toggle(std::vector<std::vector<int>> & grid, const std::vector<int> & instruction) {
    int start_x = instruction[1];
    int start_y = instruction[2];
    int end_x = instruction[3];
    int end_y = instruction[4];
...
std::vector<std::vector<int>> determine_christmas_lights(const std::vector<std::vector<int>> & instructions) {
...
int measure_light_brightness(const std::vector<std::vector<int>> & grid) {
    int count = 0;
...
int main(int argc, char * argv[]) {
    ...
    std::vector<std::vector<int>> grid = determine_christmas_lights(instructions);
    int lights_on = measure_light_brightness(grid);
